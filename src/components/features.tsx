  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <div
  id="nexus"
  className="grid h-auto grid-cols-1 gap-7 md:grid-cols-2 md:grid-rows-2"
>
  <BentoTilt className="bento-tilt_1 row-span-1 w-full md:col-span-1 md:row-span-2">
    <BentoCard
  ...
  <BentoTilt className="bento-tilt_1 w-full md:col-span-1">
    <BentoCard
